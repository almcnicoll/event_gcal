...
class Google_Service_AdExperienceReport_Resource_Sites extends Google_Service_Resource
{
   ...
   *                          whose ad experiences may have been reviewed, and it
   ...
   *                          returned by the API will lead to the verification
   *                          page, prompting the user to go through that process
   *                          before they can gain access to the Ad Experience
   *                          Report.
