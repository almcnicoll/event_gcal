...
class Google_Service_AdExchangeBuyer_Resource_Proposals extends Google_Service_Resource
{
   ...
   *                                                                database has since changed, an error will be
   *                                                                thrown. The caller should then fetch the
   *                                                                latest proposal at head revision and retry
   *                                                                the update at that revision.
   * @param  string                                  $updateAction   The proposed action to take on the proposal. This
   *                                                                 field is required and it must be set when
   *                                                                 updating a proposal.
