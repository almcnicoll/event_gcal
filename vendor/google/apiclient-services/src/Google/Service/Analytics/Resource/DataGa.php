...
class Google_Service_Analytics_Resource_DataGa extends Google_Service_Resource
{
   ...
   *                          of the form ga:XXXX, where XXXX is the Analytics view
   *                          (profile) ID.
   ...
   *                          should specify an end date formatted as
   *                          YYYY-MM-DD, or as a relative date (e.g., today,
   *                          yesterday, or 7daysAgo). The default value is
   *                          yesterday.
   * @param string $metrics   A comma-separated list of Analytics metrics. E.g.,
   *                          'ga:sessions,ga:pageviews'. At least one metric
   *                          must be specified.
