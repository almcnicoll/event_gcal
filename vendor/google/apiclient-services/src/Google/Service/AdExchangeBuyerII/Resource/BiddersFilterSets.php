...
class Google_Service_AdExchangeBuyerII_Resource_BiddersFilterSets extends Google_Service_Resource
{
   ...
   *                                                              set to be created. For example: - For a
   *                                                              bidder-level filter set for bidder 123:
   *                                                              `bidders/123` - For an account-level filter set for
   *                                                              the buyer account representing bidder 123:
   *                                                              `bidders/123/accounts/123` - For an account-level
   ...
   *                          `bidders/123/filterSets/abc` - For an
   *                          account-level filter set for the buyer account
   *                          representing bidder 123:
   *                          `bidders/123/accounts/123/filterSets/abc` - For
   *                          an account-level filter set for the child seat
   *                          buyer account 456 whose bidder is 123:
   ...
   *                          - For a bidder-level filter set for bidder 123:
   *                          `bidders/123/filterSets/abc` - For an account-level
   *                          filter set for the buyer account representing bidder
   *                          123: `bidders/123/accounts/123/filterSets/abc` - For an
   *                          account-level filter set for the child seat buyer
   *                          account 456 whose bidder is 123:
   *                          `bidders/123/accounts/456/filterSets/abc`
   * @param  array  $optParams Optional parameters.
   * @return Google_Service_AdExchangeBuyerII_FilterSet
   */
